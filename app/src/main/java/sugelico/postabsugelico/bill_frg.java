 ...
 * {@link bill_frg.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link bill_frg#newInstance} factory method to
...
public class bill_frg extends Fragment {
     ...
     * @return A new instance of fragment bill_frg.
     */
    // TODO: Rename and change types and number of parameters
    public static bill_frg newInstance(String param1, String param2) {
        bill_frg fragment = new bill_frg();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.main_view=inflater.inflate(R.layout.fragment_bill_frg, container, false);
    ...
    public void onTrackSelected(UserProfile profile,
        ...
        ((ConstraintLayout)this.main_view.findViewById(R.id.payment_data)).setVisibility(View.GONE);
        ((ConstraintLayout)this.main_view.findViewById(R.id.preorder)).setVisibility(View.VISIBLE);
