...
/**
 * Created by diegohidalgo on 12/1/16.
 */

public class companion_adapter extends BaseAdapter{
    ...
    public companion_adapter(FragmentActivity activity, UserProfile profile, ArrayList<Products> companions,
