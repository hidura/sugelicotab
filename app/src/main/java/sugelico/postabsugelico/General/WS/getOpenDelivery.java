...
public class getOpenDelivery extends AsyncTask<Void, String, JSONArray> {
    ...
    public getOpenDelivery(HashMap<String, Object> params){
        ...
        args.put("classname", params.get("classname"));
