...
public class pending_ordermobile extends RecyclerView.Adapter<pending_ordermobile.ViewHolder>  {
    ...
    public int getItemCount() {
        return profile.getSugelicomobilebills().size();
    }
    ...
    public pending_ordermobile(AppCompatActivity activity,
                      UserProfile profile,
