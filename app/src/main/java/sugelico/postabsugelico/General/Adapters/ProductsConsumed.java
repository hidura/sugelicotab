...
public class ProductsConsumed extends RecyclerView.Adapter<ProductsConsumed.ViewHolder>  {
    ...
    @Override
    public ProductsConsumed.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.bill_lst, parent, false);
        // set the view's size, margins, paddings and layout parameters

        ProductsConsumed.ViewHolder vh = new ProductsConsumed.ViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(final ProductsConsumed.ViewHolder holder, int position) {
    ...
    public ProductsConsumed(AppCompatActivity activity,
                            UserProfile profile,
                            cmpDetails companyProfile, JSONArray data) {
